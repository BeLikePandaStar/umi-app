...
// 获取商店列表数据
export const get_store_list = (params = {}) => {
  const data = [
    {
      id: '1', title: '调度专题', children: [
        {
          id: '11',
          title: '今日工作安排',
          templateTypeCode: 'list',
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/workflow.png'),
          data: [
    ...
    },
    {
      id: '999', title: '其他', children: [
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/table.png'),
          data: [
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/image.png'),
          data: [
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/tab.png'),
          data: [
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/barChart.png'),
          data: [
            ['科目', '语文', '数学', '英语'],
            ['小明', '108', '125', '103'],
            ['小红', '112', '102', '118'],
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/lineChart.png'),
          data: [
            ['科目', '语文', '数学', '英语'],
            ['小明', '108', '125', '103'],
            ['小红', '112', '102', '118'],
        ...
        },
        {
          ...
          templateConfig: "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require('./images/pieChart.png'),
          data: [
            ['科目', '语文', '数学', '英语'],
            ['小明', '108', '125', '103'],
            ['小红', '112', '102', '118'],
  ...
  return commonRequest('', params, 'get', data).then(res => {
    if (Number(res.ret) === 0) {
      return res.data
    } else {
      return []
