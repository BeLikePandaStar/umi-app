      ...
      children: [
        {
          ...
          thumbnail: require("@/assets/images/workflow.png"),
          data: {
            title: "今日工作安排",
            list: [
      ...
      children: [
        {
          ...
          thumbnail: require("@/assets/images/text.png"),
          data: {
            title: "文本",
            content:
        ...
        },
        {
          ...
          thumbnail: require("@/assets/images/link.png"),
          data: {
            title: "表单页面",
            url: "/form",
            imgSrc: require("@/assets/images/form.png")
          }
        },
        {
          id: "9993",
          ...
          templateConfig:
            "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require("@/assets/images/table.png"),
          data: [
        ...
        },
        {
          ...
          templateConfig:
            "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require("@/assets/images/tab.png"),
          data: [
            [
              "吾爱孟夫子，风流天下闻。",
              "红颜弃轩冕，白首卧松云。",
        ...
        },
        {
          ...
          templateConfig:
            "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require("@/assets/images/barChart.png"),
          data: [
            ["科目", "语文", "数学", "英语"],
            ["小明", "108", "125", "103"],
            ["小红", "112", "102", "118"],
        ...
        },
        {
          ...
          templateConfig:
            "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require("@/assets/images/lineChart.png"),
          data: [
            ["科目", "语文", "数学", "英语"],
            ["小明", "108", "125", "103"],
            ["小红", "112", "102", "118"],
        ...
        },
        {
          ...
          templateConfig:
            "{\"isSize\":true,\"maxW\":64,\"maxH\":40,\"minW\":4,\"minH\":4}",
          thumbnail: require("@/assets/images/pieChart.png"),
          data: [
            ["科目", "语文", "数学", "英语"],
            ["小明", "108", "125", "103"],
            ["小红", "112", "102", "118"],
